export const translations = {
  en: {
    ...
    "modal.stamp.title": "Create Digital Identity",
    ...
    "modal.stamp.extra": "Role, Company or ID (Optional)",
    ...
    "vault.stamp_title": "My Stamps & Marks",
    "vault.esign_title": "Digital Identities",
    "vault.empty_stamps": "No saved stamps.",
    "vault.empty_identities": "No saved identities.",
    "vault.new_identity": "+ Identity",
    "vault.new_sig": "+ Draw",
  ...
  es: {
    ...
    "modal.stamp.title": "Crear Identidad Digital",
    ...
    "modal.stamp.extra": "Cargo, Empresa o ID (Opcional)",
    ...
    "stamp.verified": "Verified",
    "vault.stamp_title": "Mis Timbres y Trazos",
    "vault.esign_title": "Identidades Digitales",
    "vault.empty_stamps": "No hay timbres guardados.",
    "vault.empty_identities": "No hay identidades guardadas.",
    "vault.new_identity": "+ Identidad",
    "vault.new_sig": "+ Dibujar",
